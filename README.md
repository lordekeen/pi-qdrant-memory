...
- An OpenAI-compatible `/embeddings` endpoint — default a local llama.cpp OpenAI-format server running [nomic-embed-text](https://huggingface.co/nomic-ai/nomic-embed-text-v1.5-GGUF) at 768 dimmension. Ollama or any hosted OpenAI-compatible API also work (set `embeddingApiKey`).
